...
const Newsletter = () => {
  return (
    <section className="mx-auto max-w-5xl items-center justify-center p-6 lg:px-4 m-10">
      <div className="text-center font-bold text-3xl lg:text-5xl leading mb-10">
        ...
        <form action="#">
          <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
            ...
            <div>
              <button
                type="submit"
                className="py-3 px-5 w-full text-sm font-normal text-center text-white rounded-full border cursor-pointer bg-eco-blue-100 sm:rounded-none sm:rounded-r-full hover:bg-slate-800"
              >
                Subscribe
              </button>
            </div>
